...
Sat Nov 15 03:07:55 PM UTC 2025
...
./src/xtl.cpp:2:77: error: code should be clang-formatted [-Wclang-format-violations]
@copyright David Mott (c) 2016. Distributed under the Boost Software License Version 1.0. See LICENSE.md or http://boost.org/LICENSE_1_0.txt for details.
                                                                            ^
./src/xtl.cpp:28:49: error: code should be clang-formatted [-Wclang-format-violations]
#define DUMP_DEFINE2(prefix, x) PRAGMA_(message( prefix QUOTE(x)))
                                                ^
./src/xtl.cpp:29:49: error: code should be clang-formatted [-Wclang-format-violations]
#define DUMP_DEFINE(x) DUMP_DEFINE2("#define " # x " ", x)
                                                ^
./src/event_trace/event_trace.cpp:2:80: error: code should be clang-formatted [-Wclang-format-violations]
 * @copyright David Mott (c) 2016. Distributed under the Boost Software License Version 1.0. See LICENSE.md or http://boost.org/LICENSE_1_0.txt for details.
                                                                               ^
./src/event_trace/event_trace.cpp:5:1: error: code should be clang-formatted [-Wclang-format-violations]
#include <xtd/process.hpp>
^
./src/event_trace/event_trace.cpp:11:7: error: code should be clang-formatted [-Wclang-format-violations]
#endif
      ^
./src/event_trace/evt_gcc.cpp:2:80: error: code should be clang-formatted [-Wclang-format-violations]
 * @copyright David Mott (c) 2016. Distributed under the Boost Software License Version 1.0. See LICENSE.md or http://boost.org/LICENSE_1_0.txt for details.
                                                                               ^
./src/event_trace/evt_gcc.cpp:3:4: error: code should be clang-formatted [-Wclang-format-violations]
 */
   ^
./src/event_trace/evt_gcc.cpp:6:13: error: code should be clang-formatted [-Wclang-format-violations]
extern "C" {
            ^
./src/event_trace/evt_gcc.cpp:9:37: error: code should be clang-formatted [-Wclang-format-violations]
  void __xtd_EventEnter(const char * fn);
                                    ^
./src/event_trace/evt_gcc.cpp:9:42: error: code should be clang-formatted [-Wclang-format-violations]
  void __xtd_EventEnter(const char * fn);
                                         ^
./src/event_trace/evt_gcc.cpp:10:27: error: code should be clang-formatted [-Wclang-format-violations]
  void __xtd_EventLeave();
                          ^
./src/event_trace/evt_gcc.cpp:13:38: error: code should be clang-formatted [-Wclang-format-violations]
  // cppcheck-suppress unusedFunction
                                     ^
./src/event_trace/evt_gcc.cpp:14:62: error: code should be clang-formatted [-Wclang-format-violations]
  void __cyg_profile_func_enter(void *, void * /*call_site*/){
                                                             ^
./src/event_trace/evt_gcc.cpp:14:63: error: code should be clang-formatted [-Wclang-format-violations]
  void __cyg_profile_func_enter(void *, void * /*call_site*/){
                                                              ^
./src/event_trace/evt_gcc.cpp:15:28: error: code should be clang-formatted [-Wclang-format-violations]
    //__xtd_EventEnter("");
                           ^
